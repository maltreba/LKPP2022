DROP MATERIALIZED VIEW SAKTIKSL.MV_KAS_TUNAI_BEN_PEN_220930_221023;
CREATE MATERIALIZED VIEW SAKTIKSL.MV_KAS_TUNAI_BEN_PEN_220930_221023
AS
--Tabel mencatat transaksi kas tunai di bendahara penerimaan
SELECT	AA.BUKTI_PEMINDAHAN,
		...
		CASE	WHEN AA.JNS_AKTIFITAS = '0' THEN 'SBS'
				...
				WHEN AA.JNS_AKTIFITAS = '6' THEN 'PEMBAYARAN_DANA_TITIPAN'
				WHEN AA.JNS_AKTIFITAS = '4' THEN 'PEMBAYARAN_DANA_TITIPAN'
...
FROM	SAKTIKSL.BPK_KAS_TUNAI_BEN_PEN_220930_221023	AA
...
create index SAKTIKSL.IDX_MV_KTBPN_221023_ba on SAKTIKSL.MV_KAS_TUNAI_BEN_PEN_220930_221023(kode_ba_satker);
create index SAKTIKSL.IDX_MV_KTBPN_221023_baES1 on SAKTIKSL.MV_KAS_TUNAI_BEN_PEN_220930_221023(kode_ba_satker||kode_eselon1_satker);
create index SAKTIKSL.IDX_MV_KTBPN_221023_AKT on SAKTIKSL.MV_KAS_TUNAI_BEN_PEN_220930_221023(JNS_AKTIFITAS);
create index SAKTIKSL.IDX_MV_KTBPN_221023_REFGL on SAKTIKSL.MV_KAS_TUNAI_BEN_PEN_220930_221023(NO_REF_GL);
create index SAKTIKSL.IDX_MV_KTBPN_221023_REF on SAKTIKSL.MV_KAS_TUNAI_BEN_PEN_220930_221023(NO_REFERENSI);